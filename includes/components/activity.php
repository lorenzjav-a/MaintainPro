...
<section class="panel"><div class="panel-header"><h2 class="panel-title">Latest activity</h2><span class="count-pill">RECENT</span></div><div class="activity-list">
  ...
  <div class="activity-item"><span class="activity-mark"><?= br_icon(str_contains($entry['event']['title'], 'verified') ? 'check' : 'clock') ?></span><div><p><a href="<?= h(br_url('complaint.php', ['id' => $entry['id']])) ?>"><?= h($entry['id']) ?></a> · <?= h($entry['event']['title']) ?></p><small><?= h(br_date($entry['event']['date'], true)) ?></small></div></div>
  <?php endforeach ?>
