...
<nav class="mobile-dock" aria-label="Quick navigation">
  ...
  <a href="complaints.php"<?= $activePage === 'complaints' ? ' class="active" aria-current="page"' : '' ?>><?= br_icon('inbox') ?><span><?= $resident ? 'My reports' : ($official ? 'Concerns' : 'Assignments') ?></span></a>
